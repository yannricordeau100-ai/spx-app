    ...
    <div className="min-h-screen bg-[#050505] text-zinc-100">
      ...
      <main className="mx-auto max-w-7xl px-4 pb-20 sm:px-6">
        ...
        <p className="mt-1 text-[14px] text-zinc-400">
          Avantage concurrentiel (Wide / Narrow / None), dernier changement de note, allocation du capital, incertitude et étoiles, pour tout l&apos;univers.
        </p>
        <div className="mt-6">
          <MoatAtelier societes={moat.societes} gics={gics.societes} noms={noms} />
        </div>
      </main>
    </div>
  );
