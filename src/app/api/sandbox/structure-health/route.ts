...
export async function GET(req: NextRequest) {
  ...
  const cleCaptcha = env("NEXT_PB_TURNSTILE_SITE_KEY") || env("NEXT_PUBLIC_TURNSTILE_SITE_KEY");
  c.push({ id: "captcha_auth", feu: cleCaptcha ? "vert" : "orange", libelle: "Captcha de connexion et d'inscription (Turnstile)", detail: cleCaptcha ? "" : "clé absente : inscription sans anti-robots" });
