...
## A. FPI ADR multi-listing aliases (11 sociétés) — meta.title_with_company

Sociétés : **ASMLF, ABBNY, ABLZF, DTEGY, ADTTF, BBVXF, BPAQF, BP.L, BCLYF, NDA-DK.CO, EDPFY**
...
calibrer le bot pour ignorer ces 11 sociétés**.

## B. V1 demo logos SVG hardcodés (5 sociétés) — header.logo_present

Sociétés : **GOOGL, META, MSCI, SPGI, CAT**

Cause : ces 5 sociétés V1 demo utilisent des logos SVG hardcodés dans
...
2 sociétés crashent server-side. Pas accessible via curl HTML (auth gate
...
fix template-level qui couvre les futures sociétés avec même profil data.

Statut : signalé dans SHARED-STATUS pour investigation conjointe
CONV-CONCEPTS + CONV-DATA. Pas bloquant pour les 838 autres sociétés.

## D. Sociétés avec yoy="N/A" légitime mais value non-numérique
...
Aucune société connue dans ce cas actuellement, mais le code est défensif.

## E. Faux-positifs bot subsector résiduels (~20-50 sociétés estimé après v3 calibration)

Bot pattern v3 : "LABEL UPPERCASE #N". Couvre la majorité mais pourrait
rater :
- Sociétés sans chip rang sous-secteur du tout (data manquante côté `ranks.subsector`)
- Sociétés où le label est en minuscule (rare)
