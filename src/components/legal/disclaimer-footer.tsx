    ...
    <footer className="mt-16 border-t border-[#1a1a1a] bg-[#070707] px-4 py-10 sm:px-6">
      <div className="mx-auto max-w-5xl">
        <div className="grid gap-8 md:grid-cols-[2fr_1fr_1fr]">
          ...
          {/* Contact */}
          <div>
            <div className="mb-3 font-mono text-[10.5px] uppercase tracking-[0.18em] text-zinc-500">Contact</div>
            <ul className="space-y-1.5 text-[12.5px]">
              <li><a href="mailto:contact@mettrik.ai" className="text-zinc-300 hover:text-zinc-100">contact@mettrik.ai</a></li>
              <li><a href="mailto:support@mettrik.ai" className="text-zinc-300 hover:text-zinc-100">support@mettrik.ai</a></li>
            </ul>
          </div>
        </div>
