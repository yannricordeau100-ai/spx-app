...
const STR = {
  fr: {
    ...
    s1_p1_a: "Le site est édité par",
    s1_p1_b: "AIRSCAPE",
    s1_p1_c: "(société d'exploitation de la marque Mettrik AI), dont le siège social est situé :",
    s1_p1_addr: "60 rue François 1er, 75008 Paris, France",
    s1_p1_d: ".",
    s1_contact_label: "Contact :",
    s1_siren_label: "SIREN :",
    s1_siren_value: "935 055 137",
    s1_tva_label: "Numéro de TVA intracommunautaire :",
    s1_tva_value: "FR16935055137",
    s1_pub_label: "Directeur de la publication :",
    s1_pub_value: "AIRSCAPE",
    ...
    s6_p1: "Les présentes mentions légales sont régies par le droit français. Tout litige relatif à leur interprétation ou à leur exécution relèvera de la compétence exclusive des tribunaux compétents de Paris.",
  },
  en: {
    title: "Legal Notice",
    ...
    s1_p1_a: "The website is published by",
    s1_p1_b: "AIRSCAPE",
    s1_p1_c: "(operating company of the Mettrik AI brand), with registered office located at:",
    s1_p1_addr: "60 rue François 1er, 75008 Paris, France",
    s1_p1_d: ".",
    s1_contact_label: "Contact:",
    s1_siren_label: "SIREN:",
    s1_siren_value: "935 055 137",
    s1_tva_label: "Intra-community VAT number:",
    s1_tva_value: "FR16935055137",
    s1_pub_label: "Publication Director:",
    s1_pub_value: "AIRSCAPE",
    s2_title: "2. Hosting",
    ...
    s6_p1: "This legal notice is governed by French law. Any dispute relating to its interpretation or performance shall fall within the exclusive jurisdiction of the competent courts of Paris.",
  },
};
