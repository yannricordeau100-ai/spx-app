...
export const DICTIONARY: Dict = {
  ...
  "stories.cat.Segments": { fr: "Segments", en: "Segments" },
  "stories.cat.Capital": { fr: "Capital", en: "Capital" },
  "stories.cat.Croissance": { fr: "Croissance", en: "Growth" },
  ...
  "faq.a.data_sources": {
    fr: "Mettrik réunit d'abord l'intégralité des indicateurs que chaque société publie officiellement : rapports annuels et trimestriels, documents réglementaires, présentations aux investisseurs et conférences de résultats. Nous y ajoutons des indicateurs rarement accessibles hors des salles de marché, recueillis auprès de sources spécialisées et de fournisseurs de données professionnels propres à chaque secteur : ceux que suivent les équipes de recherche et les investisseurs institutionnels pour lire l'activité d'une société avant qu'elle n'apparaisse dans ses comptes. Chaque chiffre reste rattaché à sa source.",
  ...
  "nav.resultats": { fr: "Derniers résultats", en: "Latest results" },
  "nav.these": { fr: "Thèse d'investissement", en: "Investment thesis" },
  "nav.att": { fr: "Anti-thèse", en: "Counter-thesis" },
