...
const STR = {
  fr: {
    ...
    s1_p1_c: ", entreprise individuelle de droit liechtensteinois (exploitant la marque Mettrik AI), établie à l'adresse :",
    s1_p1_addr: "Aeulestrasse 74, 9490 Vaduz, Liechtenstein",
    s1_p1_d: ".",
    s1_contact_label: "Contact :",
    s1_siren_label: "Forme juridique :",
    s1_siren_value: "entreprise individuelle (Einzelunternehmen) de droit liechtensteinois",
    s1_tva_label: "TVA :",
    ...
    s6_p1: "Les présentes mentions légales sont régies par le droit de la Principauté de Liechtenstein. Tout litige relatif à leur interprétation ou à leur exécution relèvera de la compétence des tribunaux ordinaires de Vaduz, sous réserve des dispositions impératives protégeant les consommateurs.",
  },
  en: {
    title: "Legal Notice",
    ...
    s1_p1_b: "R consulting",
    s1_p1_c: ", a sole proprietorship under Liechtenstein law (operating the Mettrik AI brand), established at:",
    s1_p1_addr: "Aeulestrasse 74, 9490 Vaduz, Liechtenstein",
    s1_p1_d: ".",
    s1_contact_label: "Contact:",
    s1_siren_label: "Legal form:",
    s1_siren_value: "sole proprietorship (Einzelunternehmen) under Liechtenstein law",
    s1_tva_label: "VAT:",
    ...
    s6_p1: "This legal notice is governed by the law of the Principality of Liechtenstein. Any dispute relating to its interpretation or performance shall fall within the jurisdiction of the ordinary courts of Vaduz, subject to mandatory consumer-protection provisions.",
  },
};
