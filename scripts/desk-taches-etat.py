...
taches = [
 {'titre': 'Conférences de résultats : extraction des KPI (4 dernières par société)',
  ...
  'eta': f'{h} h de calcul ({cadence} sociétés/h), coupé par les limites de session : fin estimée entre le 25 et le 26 sept',
 ...
 {'titre': 'Conférences de résultats : 9 sociétés sans 4 conférences + EA',
  'etat': '4 sans aucune conférence, 5 avec une seule (scissions, introductions récentes), EA en attente de la règle des 18 mois',
  'eta': '1 h 30 après décision (EA) et recherche d autres sources',
 ...
 {'titre': 'Sociétés disparues (rachat, faillite, retrait de la cote)',
  'etat': 'contrôle des 664 fait le 24 sept (indices du jour + cotation) ; décision de retrait à prendre',
  'eta': '1 h après décision (retrait des listes, redirection des fiches)',
