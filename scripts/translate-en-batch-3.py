...
Usage:
  ...
  python3 scripts/translate-en-batch-3.py [--limit N] [--force]
"""
...
BATCH_FILE = Path("/tmp/en-batch-3.json")
...
def main() -> int:
    ...
    print(f"[start] {len(tickers)} tickers in batch 3")
