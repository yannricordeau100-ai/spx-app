#!/usr/bin/env python3
"""SA34 batch 11 US — parse 10-Q HTM (inline XBRL) for quarterly data.

For each US ticker in batch11.txt:
...
BATCH = '/tmp/sa34-batches/batch11.txt'
TODAY = '2026-06-03'
...
def main():
    ...
    print(f'=== SA34 batch11 US ({len(tickers)} tickers) apply={apply_mode} ===')
