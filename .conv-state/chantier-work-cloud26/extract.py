#!/usr/bin/env python3
"""Cloud chunk 26 — 15 tickers. Reuse of top10 extract.py."""
import json, os, re, gzip, sys
from collections import defaultdict
from datetime import datetime

TICKERS = ["URI","USB","VEEV","VICI","VLO","VLTO","VMC","VRSK","VRSN","VRT","VRTX","VST","VTR","VTRS","VZ"]
XBRL_TICKER = {}

ENRICH_DIR = "/Users/yann/spx-app/src/data/v2-pipeline-enrich"
DATALAKE = "/Users/yann/spx-app/data-lake"
LOG = "/Users/yann/spx-app/.conv-state/chantier-quarters-log-cloud26.json"
