...
- CONV-CONCEPTS : 🔄 [15 mai 22h45] Fixes visuels backlog en parallèle 2 agents IA : (A) GE page 500 SSR crash, (B) chart fixes TTM/EventDots/logo overlap sur Bars 2D + Bars 3D + Variation. Mode RAM-light (agents Claude server-side, 0 proc Python local). Fichiers touchés : src/components/charts/{bars-chart,bars-3d-variants,delta-chart}.tsx + investigation GE-specific
