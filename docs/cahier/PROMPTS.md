...
- Objectif : créer un KPI sur une fiche (ou compléter un KPI existant : années antérieures, trimestres manquants, correction), à partir des données fournies en interne ou d'une source citée, puis vérifier en réel sur niveau2.
...
Source : <URL, document, ou "fournies en interne">
