// Batch 4 pass 4 : 4 derniers stubborns + Q via commons.
...
const FIXES = [
  { ticker: 'BEN',    wiki: 'en',      title: 'Franklin Templeton logo.png' },
  { ticker: 'PRU',    wiki: 'en',      title: 'Prudential Financial.svg' },
  { ticker: 'Q',      wiki: 'commons', title: 'Qnity Electronics logo.jpg' },
  // PODD : no logo file found on Wikipedia - skip (sera fallback monogramme)
];
